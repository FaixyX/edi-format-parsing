import { NewPdfTemplate, PdfTemplateStatus } from "@/types/pdfTemplate";
...
interface AddPdfTemplateDialogProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: () => void;
...
export function AddPdfTemplateDialog({
    isOpen,
    onClose,
    onSubmit,
    isSubmitting,
